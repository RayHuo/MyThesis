...
\usepackage[below]{placeins}    % 要求浮动的图形在它们所在的章节中排出，加 [section] 选项。
                % 而 [below] 选项则更加宽松一些，允许上一个section 的浮动图形
                % 出现在下一个section的开始部分
...
%-----------------------我的定义-----------------------
\newcommand{\papername}{回答集逻辑程序的程序分割问题及在程序化简的应用研究}
...
%其内容取自LaTeX的\markboth指令。事实上\markboth 指令用于存放两项信息，分别
...
% \fancyhead[LO]{\CJKfamily{fs}\nouppercase\rightmark}
 \fancyhead[L]{\CJKfamily{fs}\papername}
